...
def SOLVE(A, n, GUI, l=0, deltaP=0, H=0, Nu=0, SHOW_LU=False, SHOW_table=False):
    """
    Description:
        Solves the system of linear equations and graphs the results. Used both in compute_engine.py and GUI.py
    ...
    # if SHOW_table:
    #     print(table)
    return x, Y_j, stats.mean(Absolute_error), stats.mean(Relative_error)
